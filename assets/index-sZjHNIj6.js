import{p as z,s as vo,c as an,j as R,u as vi,a as Pt,b as hi,d as nr,e as sn,g as pe,r as b,f as mi,R as gi,N as ut,h as cn,i as bi,k as yi,l as xi,m as wi,L as Ci,n as O,o as Si,q as ki,t as Ei,O as Ri}from"./index-P7y5xxY_.js";import{u as ho}from"./useIsMobile-CqgSl5gX.js";import{s as tt}from"./sprite-CR3z7qaS.js";const Oi=z.div`
  display: flex;
  flex-grow: 1;
`,$i=z.main`
...
`,Ai=({onClick:e,mobileMenu:t})=>R.jsx(Ti,{children:R.jsx(Pi,{$mobileMenu:t,onClick:e,children:R.jsx("span",{})})}),Mi=()=>{const e=vi();return[Pt(hi),r=>e(r==="light"?nr("dark"):nr("light"))]},Ii=z.button`
...
`,Di=()=>{const[e,t]=Mi();return R.jsx(Ii,{onClick:()=>t(e),children:R.jsx(Li,{children:R.jsx("use",{href:`${tt}#${e==="light"?"moon-stars":"sun"}`})})})},ji=z.header`
...
`,ou=({mobileMenu:e,setMobileMenu:t,headerHeight:n})=>{const r=Pt(cn);return R.jsxs(tu,{toggled:e,customBreakPoint:`${pe.breakpoint.maxTablet}`,onBackdropClick:()=>t(!1),$profile:!!r,children:[!r&&R.jsx(ru,{$headerHeight:n}),R.jsxs(nu,{children:[r&&R.jsx(Es,{}),R.jsx(Ql,{setMobileMenu:t})]}),r&&R.jsx(pi,{})]})},iu=()=>{const[e,t]=b.useState(!1),[n,r]=b.useState(0),o=ho(),i=Pt(cn),a=()=>t(s=>!s);return b.useEffect(()=>{!o&&t(!1)},[o]),R.jsxs(R.Fragment,{children:[R.jsx(ws,{handleClick:a,mobileMenu:e,setHeaderHeight:r}),R.jsxs(Oi,{children:[R.jsx(ou,{setMobileMenu:t,mobileMenu:e,headerHeight:n}),R.jsx($i,{children:R.jsx(Ri,{})})]}),!i&&R.jsx(pi,{$isMainLayout:!0})]})},lu=iu;export{lu as default};
//# sourceMappingURL=index-sZjHNIj6.js.map
