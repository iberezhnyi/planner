import{p as Q,j as T,u as fo,a as Pt,s as di,c as tr,b as po,d as In,r as b,e as pi,R as vi,f as Mn,N as lt,g as on,h as hi,l as mi,i as R,k as gi,L as bi,O as yi}from"./index-iPUCrOcr.js";import{M as xi,a as wi,T as Ci,b as Si,s as ct}from"./Button.styled-CTL7p-cz.js";const Ei=Q.main`
  flex-grow: 1;
`,ki=({onClick:e,mobileMenu:t})=>T.jsx(xi,{children:T.jsx(wi,{$mobileMenu:t,onClick:e,children:T.jsx("span",{})})}),Ri=()=>{const e=fo();return[Pt(di),r=>e(r==="light"?tr("dark"):tr("light"))]},Oi=()=>{const[e,t]=Ri();return T.jsx(Ci,{onClick:()=>t(e),children:T.jsx(Si,{children:T.jsx("use",{href:`${ct}#${e==="light"?"moon-stars":"sun"}`})})})},Ti=Q.header`
  ${po}
...
`,Rr=Q.svg`
  ...
  fill: transparent;
  stroke: currentColor;
`,cs=()=>{const e=Pt(on),t=fo(),n=hi(),r=()=>{t(mi()),n("/login"),i(!1)},[o,i]=b.useState(!1),{refs:a,floatingStyles:s,context:c}=Qa({open:o,onOpenChange:i,whileElementsMounted:Ra}),u=Ya(c),l=Za(c),d=ns(c,{role:"menu"}),{getReferenceProps:y,getFloatingProps:f}=es([u,l,d]),p=Fn();return T.jsxs(T.Fragment,{children:[e?T.jsxs(Sr,{ref:a.setReference,...y(),children:[T.jsx(os,{children:e.firstName}),T.jsx(Er,{children:T.jsx("use",{href:`${ct}#user`})}),T.jsx(is,{className:o?"open":"",children:T.jsx("use",{href:`${ct}#arrow-down`})})]}):T.jsxs(rs,{to:"/login",children:["Log in",T.jsx(Er,{children:T.jsx("use",{href:`${ct}#user`})})]}),o&&T.jsx(Ka,{context:c,modal:!1,initialFocus:-1,children:T.jsx("div",{className:"Popover",ref:a.setFloating,style:s,"aria-labelledby":p,...f(),children:T.jsxs(as,{children:[T.jsx(kr,{role:"menuitem",children:T.jsxs(Sr,{onClick:r,className:"logout",children:[T.jsx(Rr,{children:T.jsx("use",{href:`${ct}#logout`})}),"Log out"]})}),T.jsx(kr,{role:"menuitem",children:T.jsxs(ss,{to:"/settings",children:[T.jsx(Rr,{children:T.jsx("use",{href:`${ct}#settings`})}),"Settings"]})})]})})})]})},ls=({isMobile:e,handleClick:t,mobileMenu:n})=>(console.log("isMobile :>> ",e),T.jsx(Ti,{children:T.jsxs(Pi,{children:[e&&T.jsx(ki,{onClick:()=>t(),mobileMenu:n}),T.jsx(cs,{})]})}));/*! *****************************************************************************
...
//# sourceMappingURL=index-CGZF0ufJ.js.map
